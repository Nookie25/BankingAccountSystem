...
protected ListNode tail;
	...
	/*
	 * @method PrintSortInt - transfers the linked list to an array and sorts it according to ID number directly
    ...
    /*
     * @method CreateNameSortArray - insertion sort for sorting Account by Name (A - Z)
     * @param 
